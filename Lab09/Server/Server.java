...
public class Server {
    ...
    public class ClientConnection extends Thread {
        final DataInputStream inSock; 
        final DataOutputStream outSock; 
        final Socket s; 

        public ClientConnection(Socket s, DataInputStream dis, DataOutputStream dos)  
        { 
            this.s = s; 
            this.inSock = dis; 
            this.outSock = dos; 
        ...
        try {
            ...
            while (1==1) {
                ...
                try {
                    ...
                    Thread t = new Thread( new Server().new ClientConnection(client, inSock, outSock) );
                    t.start();
